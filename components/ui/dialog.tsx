...
>(({ className, children, ...props }, ref) => (
	<DialogPortal>
		...
		<DialogPrimitive.Content
			...
			{...props}
			// Radix Select/Popover render their dropdown in a portal *outside*
			// this content node, so interacting with an open Select reads as an
			// "outside" interaction and would dismiss the dialog. Ignore interactions
			// that originate inside any popper-portaled layer. Placed after {...props}
			// so it wins, while still chaining any caller-provided handler.
			onInteractOutside={(e) => {
